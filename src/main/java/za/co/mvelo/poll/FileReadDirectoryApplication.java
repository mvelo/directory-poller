...
import za.co.mvelo.poll.filter.LastModifiedFileFilter;
import za.co.mvelo.poll.processor.FileProcessor;
...
public class FileReadDirectoryApplication {
	...
	private static final String DIRECTORY = "/incoming/statement";
